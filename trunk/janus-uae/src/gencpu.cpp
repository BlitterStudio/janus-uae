...
static int isreg (unsigned int mode)
{
...
static void genamode2 (unsigned int mode, char *reg, unsigned int size, char *name, int getv, int movem, int flags, int fixup)
{
	char namea[100];
...
static void genamode_fixup (unsigned int mode, char *reg, unsigned int size, char *name, int getv, int movem, int flags, int fixup)
{
	if (fixup != 2) {
...
static void genamode (unsigned int mode, char *reg, unsigned int size, char *name, int getv, int movem, int flags)
{
	genamode2 (mode, reg, size, name, getv, movem, flags, 0);
}
static void genamode_pre (unsigned int mode, char *reg, unsigned int size, char *name, int getv, int movem, int flags)
{
	genamode_fixup (mode, reg, size, name, getv, movem, flags, using_mmu ? 1 : 0);
}
static void genamode_post (unsigned int mode, char *reg, unsigned int size, char *name, int getv, int movem, int flags)
{
	if (using_mmu)
		genamode_fixup (mode, reg, size, name, getv, movem, flags, 2);
}

static void genastore_2 (char *from, unsigned int mode, char *reg, unsigned int size, char *to, int store_dir, int flags)
{
	switch (mode) {
	case Dreg:
		switch (size) {
...
static void genastore (char *from, unsigned int mode, char *reg, unsigned int size, char *to)
{
	genastore_2 (from, mode, reg, size, to, 0, 0);
}
static void genastore_rev (char *from, unsigned int mode, char *reg, unsigned int size, char *to)
{
	genastore_2 (from, mode, reg, size, to, 1, 0);
}
static void genastore_fc (char *from, unsigned int mode, char *reg, unsigned int size, char *to)
{
...
static void genmovemel (uae_u16 opcode)
{
	...
	genamode ((amodes) table68k[opcode].dmode, "dstreg", (wordsizes) table68k[opcode].size, "src", 2, 1, 0);
	start_brace ();
...
static void genmovemel_ce (uae_u16 opcode)
{
	...
	printf ("\tunsigned int dmask = mask & 0xff, amask = (mask >> 8) & 0xff;\n");
	printf ("\tuae_u32 v;\n");
	genamode ((amodes) table68k[opcode].dmode, "dstreg", (wordsizes) table68k[opcode].size, "src", 2, 1, GF_AA);
...
static void genflags_normal (flagtypes type, unsigned int size, char *value, char *src, char *dst)
{
...
static void genflags (flagtypes type, unsigned int size, char *value, char *src, char *dst)
{
...
static void force_range_for_rox (const char *var, unsigned int size)
{
...
static const char *cmask (unsigned int size)
{
	switch (size) {
...
static void shift_ce (unsigned int dmode, int size)
{
...
static void gen_opcode (unsigned long int opcode)
{
	...
	{
		int c = 0;
		genamode ((amodes) curi->smode, "srcreg", (wordsizes) curi->size, "src", 1, 0, 0);
		genamode ((amodes) curi->dmode, "dstreg", (wordsizes) curi->size, "dst", 1, 0, 0);
...
static char *decodeEA (unsigned int mode, unsigned int size)
{
	static char buffer[80];
