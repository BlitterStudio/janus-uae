...
typedef struct Element {
  ...
  LONG    idc;     // windows rc identifier (IDC_CPU0, IDC_Z3CHIPRAM, etc)
  ULONG   group;   // group id (for AUTORADIOBUTTON)
  ...
  LONG   x,y,w,h; // fixed position and height
