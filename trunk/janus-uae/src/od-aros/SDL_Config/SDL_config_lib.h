...
class DECLSPEC ConfigFile
 {
   ...
   */
   ...
   /* Function: Open   
    Essentialy the same thing as <CFG_File::CFG_OpenFile>.
   */
   bool cfg_Open( const char * filename, const CFG_Settings * settings = 0 );

   /* Function: Open   
    Essentialy the same thing as <CFG_File::CFG_OpenFile_RW>.
   */
   bool cfg_Open( SDL_RWops * source, const CFG_Settings * settings = 0 );
   ...
   */
   ...
   bool           cfg_Read ( CFG_String_Arg entry, CFG_Bool defaultVal );
   Sint32         cfg_Read ( CFG_String_Arg entry, Sint32 defaultVal );
   CFG_Float      cfg_Read ( CFG_String_Arg entry, CFG_Float defaultVal );
   CFG_String_Arg cfg_Read ( CFG_String_Arg entry, CFG_String_Arg defaultVal );
   ...
   */
   ...
   int cfg_Write ( CFG_String_Arg entry, CFG_Bool value       );
   int cfg_Write ( CFG_String_Arg entry, Sint32 value         );
   int cfg_Write ( CFG_String_Arg entry, CFG_Float value      );
   int cfg_Write ( CFG_String_Arg entry, CFG_String_Arg value );
