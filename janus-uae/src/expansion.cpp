...
static void allocate_expamem (void)
{
  ...
  DebOut("currprefs.rtgmem_size %d := changed_prefs.rtgmem_size %d\n", currprefs.rtgmem_size, changed_prefs.rtgmem_size);
